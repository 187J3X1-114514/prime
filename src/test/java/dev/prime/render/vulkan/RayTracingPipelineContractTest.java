...
final class RayTracingPipelineContractTest {
    ...
    void rayTracingShaderGroupsHaveTheExpectedShape() {
        ...
        assertEquals(1, RayTracingPipeline.raygenShaderStage(6));
        assertEquals(1, RayTracingPipeline.raygenShaderStage(7));
        assertEquals(1, RayTracingPipeline.raygenShaderStage(8));
