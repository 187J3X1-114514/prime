...
2. `raw numerical anomalies`：在积分器清洗或拒绝前记录异常。黑色正常，品红为 NaN，红/青为正/负无穷，白色为混合非有限值，蓝色为有限负值，绿色为样本拒绝，粉色为非法方向，紫色为超出单位范围，黄色为超出当前 FP16 上限 65504。
