...
final class ShaderAbiTest {
    ...
    void fixedRecordSizesAndBindingsMatchTheContract() {
        ...
        assertEquals(5, ShaderAbi.WAVEFRONT_SUN_QUEUE);
        assertEquals(6, ShaderAbi.WAVEFRONT_TRANSPARENT_RESOLVE_QUEUE);
        ...
        assertEquals("agx-hsv", ShaderAbi.DEFAULT_DISPLAY_TRANSFORM);
