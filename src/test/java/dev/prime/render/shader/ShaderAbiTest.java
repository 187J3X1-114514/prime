...
final class ShaderAbiTest {
    ...
    void fixedRecordSizesAndBindingsMatchTheContract() {
        ...
        assertEquals(2, ShaderAbi.WAVEFRONT_SHADE_QUEUE);
        assertEquals(3, ShaderAbi.WAVEFRONT_TRANSPARENT_SHADE_QUEUE);
        ...
        assertEquals(28, ShaderAbi.PATH_AREA_LIGHT_SAMPLING_MODE_SHIFT);
        assertEquals(0x1, ShaderAbi.PATH_AREA_LIGHT_SAMPLING_MODE_MASK);
        assertEquals(0, ShaderAbi.PATH_AREA_LIGHT_SAMPLING_MODE_PURE_LIGHT_TREE);
        assertEquals(1, ShaderAbi.PATH_AREA_LIGHT_SAMPLING_MODE_WIDE_RIS_4X4);
    ...
    void generatedOffsetsMatchTheStd430Layout() {
        ...
        assertEquals(0, ShaderAbi.WORLD_LIGHT_SUMMARY_BOUNDS_MIN_POWER_OFFSET);
        assertEquals(16, ShaderAbi.WORLD_LIGHT_SUMMARY_BOUNDS_MAX_PROPOSAL_PDF_OFFSET);
        assertEquals(32, ShaderAbi.WORLD_LIGHT_SUMMARY_DIRECTION_SECTION_RESERVED_OFFSET);
        assertEquals(0, ShaderAbi.LIGHT_ALIAS_ENTRY_ALIAS_PROBABILITY_OFFSET);
        assertEquals(4, ShaderAbi.LIGHT_ALIAS_ENTRY_ALIAS_INDEX_OFFSET);
        ...
        assertEquals(48, ShaderAbi.LIGHT_EMITTER_NORMAL_PROPOSAL_PDF_OFFSET);
        ...
        assertEquals(24, ShaderAbi.SHARC_FRAME_DIAGNOSTICS_ADDRESS_OFFSET);
